...
#Step 1, run OrthoFinder to identify orthologies sequence of the 19 species.
...
#Step 3, pick best hit of Tdro in the identified single copy genes. 
...
python rename.gene.trees.py #Rename leaf name in each of the gene trees as Orthofinder added a additianal '_' to the leaf name
